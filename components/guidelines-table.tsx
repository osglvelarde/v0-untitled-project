...
export function GuidelinesTable() {
  ...
  const guidelines: Guideline[] = [
    ...
    },
    {
      ...
      level: "A",
      summary:
        "Provide audio description or text alternative for video content",
      w3cLink:
    ...
    },
    {
      ...
      level: "AAA",
      summary:
        "Provide sign language interpretation for prerecorded audio content",
      w3cLink:
    ...
    },
    {
      ...
      level: "AAA",
      summary:
        "Provide extended audio description for prerecorded video content",
      w3cLink:
    ...
    },
    {
      ...
      level: "AA",
      summary:
        "Input fields collecting personal data have appropriate autocomplete attributes",
      w3cLink:
    ...
    },
    {
      ...
      level: "AAA",
      summary:
        "All functionality is available from a keyboard without exceptions",
      w3cLink:
    ...
    },
    {
      ...
      level: "AAA",
      summary:
        "Content doesn't flash more than three times per second (no exceptions)",
    ...
    },
    {
      ...
      level: "AAA",
      summary:
        "Users can disable non-essential animation triggered by interaction",
      w3cLink:
    ...
    },
    {
      ...
      level: "A",
      summary:
        "Provide a way to bypass blocks of content that are repeated on multiple pages",
    ...
    },
    {
      ...
      level: "AAA",
      summary:
        "Focus indicator is clearly visible with minimum area and contrast",
      w3cLink:
    ...
    },
    {
      ...
      level: "A",
      summary:
        "Functions triggered by motion can also be operated by user interface components",
      w3cLink:
    ...
    },
    {
      ...
      level: "AAA",
      summary:
        "Size of target for pointer inputs is at least 44 by 44 CSS pixels",
      w3cLink:
    ...
    },
    {
      ...
      level: "AA",
      summary:
        "Functions that require dragging have a non-dragging alternative",
      w3cLink:
    ...
    },
    {
      ...
      level: "AAA",
      summary:
        "Provide mechanism for identifying specific definitions of words used in an unusual way",
    ...
    },
    {
      ...
      level: "AAA",
      summary:
        "Provide mechanism for identifying expanded form of abbreviations",
    ...
    },
    {
      ...
      level: "AAA",
      summary:
        "Provide text that is not more complex than lower secondary education level",
    ...
    },
    {
      ...
      level: "AAA",
      summary:
        "Provide mechanism for identifying specific pronunciation of words",
    ...
    },
    {
      ...
      level: "AA",
      summary:
        "Submissions with legal or financial consequences can be reviewed, corrected, or confirmed",
      w3cLink:
  ...
  useEffect(() => {
    ...
    if (levelFilter && levelFilter !== "all") {
      filtered = filtered.filter(
        (guideline) => guideline.level === levelFilter
      );
    }

    if (principleFilter && principleFilter !== "all") {
      filtered = filtered.filter(
        (guideline) => guideline.principle === principleFilter
      );
    }
  ...
  return (
    <div className="space-y-4">
            ...
            {paginatedGuidelines.length > 0 ? (
              paginatedGuidelines.map((guideline) => (
                <TableRow key={guideline.id}>
                  ...
                  <TableCell>
                    <Badge className={getLevelColor(guideline.level)}>
                      {guideline.level}
                    </Badge>
                  </TableCell>
      ...
      <div className="text-sm text-gray-500">
        ...
        {Math.min(page * itemsPerPage, filteredGuidelines.length)} of{" "}
