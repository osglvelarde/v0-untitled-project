    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <main>
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">Understanding Section 508</h2>
          <p className="mb-4">
            Section 508 is an amendment to the United States Workforce Rehabilitation Act of 1973, requiring federal
            agencies to develop, procure, maintain, and use information and communications technology (ICT) that is
            accessible to people with disabilities.
          </p>
          <p className="mb-4">
            Section 508 standards are now aligned with WCAG 2.0 Level AA success criteria, making WCAG compliance
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">Web Content Accessibility Guidelines (WCAG)</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">WCAG is organized around four principles, often referred to as POUR:</p>
          <ul className="list-disc pl-8 mb-4">
            <li className="mb-2">
              <strong>Perceivable</strong> - Information and user interface components must be presentable to users in
            ...
            <li className="mb-2">
              <strong>Robust</strong> - Content must be robust enough that it can be interpreted by a wide variety of
      ...
      <footer className="mt-16 pt-8 border-t border-gray-200">
        <p className="text-sm text-gray-600">
          This resource is designed to help developers and content creators understand and implement accessibility
          guidelines. For the most up-to-date and authoritative information, always refer to the official W3C
          documentation.
        </p>
      </footer>
    </div>
